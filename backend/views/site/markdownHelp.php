...
They are always to be used in the <code>KEYWORD:UUID</code> format, for example
<code>CH:302cb5e301d94b478a880b22ff0d4780</code>. If used without any wrap, they will create an anchor tag with
the official object's name as the content and the link to the object itself. If they are used in a Markdown link wrap
(e.g. <code>[Name](CH:302cb5e301d94b478a880b22ff0d4780</code>)), the given name will be used as anchor's content
instead. The requested object must be created first, otherwise the tag will not be rendered.
