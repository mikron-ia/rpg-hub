...
<div class="project-index">
    ...
    <div class="buttoned-header">
        ...
        <?= Html::a(
            Yii::t('app', 'BUTTON_PROJECT_CREATE'),
        ...
        <?= GridView::widget([
            ...
            'columns' => [
                ...
                [
                    ...
                    'headerOptions' => ['class' => 'text-center'],
                    'contentOptions' => ['class' => 'text-center'],
                    'value' => fn(Project $model) => $model->getCodeName(),
                ],
                [
                    ...
                    'buttons' => [
                        'view' => function ($url, Project $model, $key) {
                            return Html::a(
                                ...
                                Yii::$app->urlManager->createUrl(['project/view', 'key' => $model->key]),
                        ...
                        'update' => function ($url, Project $model, $key) {
                            return Html::a(
                                ...
                                Yii::$app->urlManager->createUrl(['project/update', 'key' => $model->key]),
