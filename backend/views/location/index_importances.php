...
$columnsFixed = [
    [
        'attribute' => 'name',
        'value' => function (LocationWithImportance $model) {
...
foreach ($epic->participants as $participant) {
    $columnsVariable[] = [
        'attribute' => sprintf(LocationWithImportance::USER_NAME_PATTERN, $participant->user_id),
...
$columnsAction = [
    [
        ...
        'buttons' => [
            'view' => function ($url, LocationWithImportance $model, $key) {
                return Html::a(
            ...
            'update' => function ($url, LocationWithImportance $model, $key) {
                return Html::a(
...
<div class="person-index">
    <div class="buttoned-header">
        ...
        <?= Html::a(
            Yii::t('app', 'LOCATION_BUTTON_SEE_MAIN_INDEX'),
            ['index', 'epic' => $epic->key],
    ...
    <div class="col-md-3" id="filter">
        <?php echo $this->render(
            '_search',
            ['model' => $searchModel, 'epic' => $epic, 'actionUrl' => 'index-importance']
        ); ?>
    </div>
</div>