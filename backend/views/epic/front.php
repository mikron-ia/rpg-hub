...
<div class="site-index">
    <div class="text-center">
        ...
        <div class="btn-group btn-group-lg">
            <?= Html::a(
                Yii::t('app', 'BUTTON_LOCATION'),
                ['location/index', 'epic' => $epic->key],
                ['class' => 'btn btn-lg btn-primary'],
            ); ?>
        </div>
        ...
        <div class="btn-group btn-group-lg">
            <?= Html::a(
                Yii::t('app', 'BUTTON_IMAGES'),
                ['image/index', 'epic' => $epic->key],
                ['class' => 'btn btn-lg btn-primary'],
            ); ?>
        </div>
        ...
        <div class="btn-group btn-group-lg">
            <?= Html::a(
                Yii::t('app', 'BUTTON_SECRETS'),
                ['secret/index', 'epic' => $epic->key],
                ['class' => 'btn btn-lg btn-primary'],
            ); ?>
        </div>
            ...
            <div class="col-md-8">
                ...
                <div>
                    <?php if ($recap) {
                        ...
                        echo $recap->getContentFormattedForOperator();
                    } else {
