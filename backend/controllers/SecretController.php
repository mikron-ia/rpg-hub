...
class SecretController extends CmsController
{
    use EpicAssistance;
    ...
    public function actionView(string $key): string
    {
        ...
        if (!$model->canUserViewYou()) {
            Secret::throwExceptionAboutView();
        }
    ...
    {
        if (!Secret::canUserCreateThem()) {
            Secret::throwExceptionAboutCreate();
        }
    ...
    public function actionUpdate(string $key): Response|string
    {
        ...
        if (!$model->canUserControlYou()) {
            Secret::throwExceptionAboutControl();
        }
     ...
     */
    protected function findModel(string $key): ?Secret
    {
        if (($model = Secret::findOne(['key' => $key])) !== null) {
            return $model;
        }

        throw new NotFoundHttpException(Yii::t('app', 'SECRET_NOT_AVAILABLE'));
    }
}
