...
/* @var $dataProviderWithoutLimits ActiveDataProvider */
...
$mainTab = [
    'label' => $labelForMain,
    'content' => $this->render('_index_characters_list', ['dataProvider' => $dataProvider]),
    'encode' => false,
    'active' => true,
];
...
$favoriteTab = [
    ...
    'content' => $this->render('_index_characters_list', ['dataProvider' => $favorites]),
    'encode' => false,
    'active' => false,
];
...
$groupTabs = array_map(function (CharacterListDataObject $tabData) {
    return [
        'label' => $tabData->name,
        'content' => $this->render('_index_characters_list', ['dataProvider' => $tabData->dataProvider]),
        'encode' => false,
        'active' => false,
    ];
}, $tabsFromGroupData);
