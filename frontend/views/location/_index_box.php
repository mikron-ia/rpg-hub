...
<div id="location-<?php echo $model->key; ?>" class="<?= $classesForBox ?>" title="<?= $titleText ?>">
    ...
    <span class="index-box-header-icon index-box-header-icon-top glyphicon <?= $favoriteClass ?> favorite-button"
          data-location-key="<?= $model->key ?>"
          data-scribble-key="<?= $scribbleObject?->key ?>"
          title="<?= $favoriteTitle ?>"
    ></span>

    <span class="index-box-header-icon index-box-header-icon-bottom glyphicon <?= $scribbleClass ?> scribble-button"
          data-location-key="<?= $model->key ?>"
          data-location-name="<?= Yii::t('app', 'SCRIBBLE_TITLE') . ': ' . $model->name ?>"
          title="<?= $scribbleTitle ?>"
    ></span>
