...
return [
    ...
    'USER_CREATION_FAILED_NO_IDEA' => 'User account creation failed. Reason:',
    'USER_CREATION_FAILED_WRONG_TOKEN' => 'User account creation failed due to error in token. Reason:',
