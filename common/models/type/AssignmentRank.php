...
enum AssignmentRank: string
{
    ...
    {
        return match ($this) {
            self::Vital => Yii::t('app', 'ASSIGNMENT_RANK_EXPANDED_VITAL'),
            self::Major => Yii::t('app', 'ASSIGNMENT_RANK_EXPANDED_MAJOR'),
            self::Minor => Yii::t('app', 'ASSIGNMENT_RANK_EXPANDED_MINOR'),
            self::Other => Yii::t('app', 'ASSIGNMENT_RANK_EXPANDED_OTHER'),
        };
    }
}
