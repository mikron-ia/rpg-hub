...
class m260427_133529_v1_7_0 extends Migration
{
    ...
    public function safeUp(): void
    {
        ...
        $this->addColumn('{{%seen}}', 'times_seen', $this->bigInteger()->unsigned()->defaultValue(0));
        $this->addColumn('{{%seen}}', 'times_seen_since_update', $this->bigInteger()->unsigned()->defaultValue(0));
    }

    #[Override]
    public function safeDown(): void
    {
        $this->dropColumn('{{%seen}}', 'times_seen_since_update');
        $this->dropColumn('{{%seen}}', 'times_seen');
